...
class ProductSerializer(serializers.ModelSerializer):
    class Meta:
        model = Product
        #fields = '__all__'
        fields = ['id', 'title', 'subtitle','slug','category','description', 'price', 'stock_quantity', 'image', 'partner_store', 'created_at']
...
class ProductSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Product
        #fields = '__all__'
        fields = ['id', 'title', 'slug','subtitle','description','category', 'category_name','price', 'stock_quantity', 'image', 'is_subscription_eligible', 'partner_store', 'store_location', 'created_at']
